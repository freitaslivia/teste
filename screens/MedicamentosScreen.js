    ...
    useEffect(() => {
        const fetchMedicamentos = async () => {
            try {
                ...
                const response = await fetch(`https://yaso.azurewebsites.net/medicamentos/${userId}`);
                    ...
                    <View key={item.id} style={styles.itemContainer}>
                        ...
                        {expandedItem === item.id && (
                            <View style={styles.itemContentContainer}>
                                ...
                                <Text style={styles.itemContent}>Data: {item.data}</Text>
                                <Text style={styles.itemContent}>Dosagem: {item.dosagem}</Text>
                                <Text style={styles.itemContent}>Período: {item.periodo}</Text>
                            </View>
                        )}
                    </View>
                ))}
